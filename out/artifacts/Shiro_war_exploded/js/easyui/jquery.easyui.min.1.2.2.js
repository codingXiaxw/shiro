...
},beforePageText:"Page",afterPageText:"/ {pages}",displayMsg:"Displaying {from} to {to} of {total} items"};
})(jQuery);
(function($){
function _7c(_7d){
var _7e=$(_7d);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"该项必填",invalidMessage:null,rules:{email:{validator:function(_2fa){
